...
<html lang="en" class="no-js">
	<head>
		...
		.pater::after {
			content: 
		<?php if($_SESSION['user']=="seba@yahoo.com"){ 
	...
	<body class="demo-2 loading"> 
		<main>
			...
			<script>
				if(screen.width > 800) {
					...
					document.getElementById("logsign").style.top = "0"; 
						...
						<div class="morph-button morph-button-modal morph-button-modal-3 morph-button-fixed" style="width: 50%">
							<button id="buttonSignUp" style="left: 0%; top: 0%; height: 70%; width: 60%; color: white; background-color: transparent;">Signup</button>
							<div class="morph-content">
								<div>
									<div class="content-style-form content-style-form-1">
										...
										<h2>Sign Up</h2>
										<form>
											<p><label style="color: rgba(0,0,0,0.5)">Email</label><input type="email" /></p>
											<p><label style="color: rgba(0,0,0,0.5)">Password</label><input type="password" /></p>
											<p><label style="color: rgba(0,0,0,0.5)">Repeat Password</label><input type="password" /></p>
						...
						<div id="mobileErrorP" class="morph-button morph-button-modal morph-button-modal-2 morph-button-fixed">
							...
							<div class="morph-content" id="mobileLong">
								<div>
									<div class="content-style-form content-style-form-2">
										<!--<span class="icon icon-close">Close the dialog</span>--> 
										<h2>Login</h2>
										<form action="" method="POST">
											<p><label style="color: rgba(0,0,0,0.5)">Email</label><input name="n" type="email" /></p>
											<p><label style="color: rgba(0,0,0,0.5)">Password</label><input name="p" type="password" /></p>
			...
			<div class="content content--fixed" id="headUp"> 
				<header class="codrops-header">
				  <h1 class="codrops-header__title">
					<?php if($_SESSION["user"]=="seba@yahoo.com")
						echo "<div>Sebastian's myHaum menu </div>"; 
					?> 
					</h1>
				</header>	
			...
			<div class="content-wrap">
				...
				<?php 
					...
					if($_SESSION["user"]=="seba@yahoo.com"){
						echo "<a href='../display.php'>Sebastian</a>!";
					}
					else{
					$input = array("friend!", "beautiful!", "cool one!", "bud!", "gorgeous!", "amigo¡");
					echo $input[rand(0, count($input) - 1)]; }
				?> </font> <br> 
				<font size="3em" class="content__big"> This is myHaum security's webpage. Scroll <span onclick='destroySession();'>down</span> for more! </font>
			</div> 
			...
			<div class="content-wrap">
				<div class="content content--layout content--layout-3">
					...
					<a href="#" class="content__link">Discover more</a>
				</div>
			</div> 
							...
							<div class="morph-content">
								...
								<div> 
									<div class="content-style-video">
										...
										<div class="video-mockup"><iframe frameborder="0" allowfullscreen width="100%" height="112%" src="https://youtube.com/embed/akqDwGKqKaI">
										</iframe></div>
									</div>
								</div>
							</div>
			...
			<div class="content-wrap">
				<div class="content content--layout content--layout-1">
					...
					<p class="content__desc">You can pre-order our product <a href="#">here</a> and you might get a gift for becoming a tester. </p> 
				</div>
			</div> 
			...
			<div class="content-wrap">
				<div id="mobileErrorP2" class="content content--layout content--layout-2">
					...
					<h3 class="content__title">invest</h3>
					<p class="content__desc"> 

						Do you see potential growth within this project's limits? Are you an investor? Search no more, we want you. <a href="#"> Here </a> is the contact page.  
							...
							<div>
								<div class="content-style-form content-style-form-4">
									...
									<form id="newsletter" method="post" action="#">
										<p><label>Your Email Address</label><input name="email" type="email"/><span>We promise, we won't send you any spam. Just love.</span></p>
		...
		<script> 
			...
			function subClick() { console.log("cacat"); 
